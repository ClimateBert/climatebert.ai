...
import { FAULogo } from "../core/components/logos/fau"
import { UZHLogo } from "../core/components/logos/uzh"
import { ETHZLogo } from "../core/components/logos/ethz"
  ...
  return (
    <>
      <div className="h-screen ">
        <Navbar />
        <div className="flex flex-col justify-center h-full pt-16 -mt-16">
          <div className="flex justify-center text-center md:text-left">
            <div className="flex items-center justify-start text-coolGray-50">
              <div className="flex flex-col items-center space-y-20">
                ...
                <Link href="/analyzer">
                  <a className="inline-flex justify-center px-20 py-3 text-2xl font-semibold text-white duration-500 bg-black border-2 border-black hover:bg-opacity-80 hover:text-black hover:bg-white">
                    Start Now
                  </a>
                </Link>
