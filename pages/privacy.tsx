      ...
      <div className="relative px-4 py-8 sm:px-6 lg:px-8 lg:py-20">
        ...
        <div className="mx-auto mt-6 prose prose-lg text-slate-500 prose-blue">
          ...
          <p>
            ...
            interest of secure, fast, and efficient provision of our online
            services by a professional provider (Art. 6(1)(f) GDPR).
          </p>
          <p>
          ...
          <p>
            Climatebert - Bingler Kraus Leippold Webersinke GbR
            <br />
            Treibberg 9<br />
            90403 Nürnberg
          </p>
          ...
          <p>
            ...
            instance by clicking on the “Unsubscribe” link in the newsletter.
            This shall be without prejudice to the lawfulness of any data
            processing transactions that have taken place to date.
          </p>
          <p>
            ...
            newsletter or after the purpose has ceased to apply. We reserve the
          ...
          <p>
            ...
            the uniform use of fonts on this site. These Google fonts are
            locally installed so that a connection to Google’s servers will not
            be established in conjunction with this application.
          </p>
          <p>
          ...
          <p>
            ...
            necessary for the establishment, content organization or change of
            the legal relationship (data inventory). These actions are taken on
            the basis of Art. 6(1)(b) GDPR, which permits the processing of data
            for the fulfilment of a contract or pre-contractual actions. We
            collect, process, and use personal data concerning the use of this
            website (usage data) only to the extent that this is necessary to
          ...
          <p>
            ...
            the order or the termination of the business relationship. This
