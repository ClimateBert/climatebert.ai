      ...
      <div className="relative px-4 py-8 sm:px-6 lg:px-8 lg:py-20">
        ...
        <div className="mx-auto mt-6 prose prose-lg text-gray-500 prose-blue">
          ...
          <p>
            ...
            you enter our site (third-party cookies). These cookies enable you or us to take
          ...
          <p>
            ...
            shopping cart function or the display of videos). The purpose of other cookies may be
            the analysis of user patterns or the display of promotional messages.
          </p>
          <p>
          ...
          <p>
            ...
            on the basis of your consent (Art. 6(1)(a) GDPR) if it has been obtained.
          </p>
          <p>
          ...
          <p>
            ...
            information for the sending of the newsletter at any time, for instance by clicking on
            the “Unsubscribe” link in the newsletter. This shall be without prejudice to the
          ...
          <p>
            ...
            the newsletter or after the purpose has ceased to apply. We reserve the right to delete
            or block e-mail addresses from our newsletter distribution list at our own discretion
          ...
          <p>
            ...
            stored by us or the newsletter service provider in a blacklist to prevent future
            mailings. The data from the blacklist is used only for this purpose and not merged with
            ...
            6(1)(f) GDPR). The storage in the blacklist is indefinite.
            <strong>
