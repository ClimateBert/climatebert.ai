                ...
                <div className="mt-12 text-black">
                  ...
                  <div className="flex flex-col items-center justify-center max-w-md gap-4 mx-auto mt-3 md:flex-row">
                    <input
                      ...
                      name="email"
                      id="email"
                      className="flex-grow block w-full h-12 duration-700 border border-gray-500 rounded shadow md:w-auto form-input hover:border-black focus:border-black focus:outline-none hover:shadow-cta focus:shadow-cta"
                      placeholder="Enter your email"
                    />
                    <button
                      type="button"
                      className="block w-full h-12 px-4 text-white uppercase duration-1000 border border-black rounded shadow md:w-auto whitespace-nowrap medium white bg-gradient-to-t from-black via-coolGray-800 to-black hover:from-white hover:via-coolGray-100 hover:to-white hover:text-black hover:border-black focus:outline-none hover:shadow-cta"
                    >
