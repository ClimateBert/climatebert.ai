	...
	const posts = [
		{
			...
			description: "If you say the word “green activist” to a corporate executive, Greta Thunberg may spring to mind — and provoke fear. Today, however, there is another force to watch: robots.",
			date: "March 18, 2021",
		},
		{
			title: "Bloomberg",
			href: "https://www.bloomberg.com/news/articles/2021-03-12/the-risk-of-letting-big-finance-write-its-own-climate-rules",
			description: "The industry is pushing for voluntary standards, but the stakes may be too high to wait and see if it that’s enough.",
			date: "March 12, 2021",
		},
		{
			title: "Climate Risk Review",
			href: "https://www.climateriskreview.com/p/researchers-set-an-nlp-model-loose",
			description: "Researchers set an NLP model loose on TCFD disclosures. It found scant evidence of useful climate information",
			date: "March 4, 2021",
		},
		{
