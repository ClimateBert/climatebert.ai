    ...
    <>
      ...
      <div className="relative px-4 py-8 sm:px-6 lg:px-8 lg:py-20">
        <div className="mx-auto text-lg">
          <h1>
            ...
            <span className="block mt-2 text-3xl font-extrabold leading-8 tracking-tight text-center text-slate-900 sm:text-4xl">
              Cheap Talk in Corporate Climate Commitments: <br /> The Role of Active Institutional Ownership, Signaling, Materiality, and Sentiment
            </span>
          </h1>
        </div>
        <div className="mx-auto mt-6 prose prose-lg text-slate-500 prose-blue">
          ...
          <p>
            The finetuned TCFD category model with text classification head is publicly available on 🤗 Hugging Face Hub: <a
        ...
        <div className="mx-auto text-lg">
          <h1>
            ...
            <span className="block mt-2 text-3xl font-extrabold leading-8 tracking-tight text-center text-slate-900 sm:text-4xl">
              Cheap talk and cherry-picking: <br /> What ClimateBert has to say on corporate climate risk disclosures
            </span>
          </h1>
        </div>
        <div className="mx-auto mt-6 prose prose-lg text-slate-500 prose-blue">
